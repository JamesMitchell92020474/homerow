...
window.Lessons = (() => {
  ...
  const LESSON_DATA = [
...

    {
      ...
      exercises: [
        ...
        },
        {
          ...
          type: 'words',
          label: 'Real Words',
          text: 'add dad sad fad ads adds dads fads sass',
        },
        {
          id: 'sentence',
          type: 'sentence',
          label: 'Sentence Practice',
          text: 'sad dads add fads a dad adds ads',
        },
      ],
    },

    {
      ...
      newKeysNote: 'Right Hand Home Row — these complete all eight home row keys. Both hands are now in position.',
      phase: 'beginner',
      newKeys: ['j', 'k', 'l', ';'],
      ...
      exercises: [
        ...
        },
        {
          ...
          text: 'all ask fall lass lads flask salads dads asks falls flak fads',
        },
        {
          id: 'sentence',
          type: 'sentence',
...

    {
      ...
      exercises: [
        ...
        },
        {
          ...
          type: 'sentence',
          label: 'Sentence Practice',
          text: 'a side desk fails all ideas slide aside fill a field',
        },
      ],
    },

    {
      ...
      exercises: [
        ...
        },
        {
          ...
          type: 'sentence',
          label: 'Sentence Practice',
          text: 'take a total of old tools a stool is solid toast is ideal',
        },
      ],
    },

    {
      ...
      phase: 'beginner',
      newKeys: ['n', 'r'],
      allKeys: ['a', 's', 'd', 'f', 'j', 'k', 'l', ';', 'e', 'i', 't', 'o', 'n', 'r', ' '],
      targetWpm: 23,
      targetAccuracy: 90,
      sessionLength: { min: 15, max: 20 },
      exercises: [
        ...
        },
        {
          ...
          type: 'words',
          label: 'New Words',
          text: 'rain rail train rent learn rind return stride real note role iron',
        },
        {
          id: 'sentence',
          type: 'sentence',
          label: 'Sentence Practice',
          text: 'learn to train in late rain rent a real iron trail',
        },
      ],
    },
...

    {
      ...
      exercises: [
        ...
        },
        {
          ...
          type: 'sentence',
          label: 'Sentence Practice',
          text: 'you truly study this year your unity and duty are real',
        },
      ],
    },
